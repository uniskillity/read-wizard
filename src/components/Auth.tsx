...
import { BookOpen, Eye, EyeOff, Sparkles, ArrowRight, Library, Users, BookMarked, Mail, Lock, GraduationCap } from "lucide-react";
...
export const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/80">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/3 right-1/4 w-16 h-16 border border-white/20 rounded-xl rotate-45" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div className="flex items-center gap-3">
            <div className="h-14 w-14 rounded-2xl bg-white/15 backdrop-blur-xl flex items-center justify-center shadow-lg border border-white/20">
          ...
          <div className="space-y-10 max-w-lg">
            <div className="space-y-6">
              ...
              <h1 className="text-5xl xl:text-6xl font-bold text-white leading-[1.1] tracking-tight">
                Your Gateway to
                <span className="block mt-1 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
                  Academic Excellence
                </span>
              </h1>
            ...
            <div className="flex flex-wrap gap-3">
              {features.map((feature, index) => (
                <div 
                  key={index}
                  className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/10 hover:bg-white/15 transition-colors cursor-default"
                >
      ...
      <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center p-6 sm:p-10 relative bg-background">
        ...
        <div className="w-full max-w-[380px] relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full h-12 rounded-xl font-semibold text-base shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all group mt-2" 
              disabled={loading}
            >
              {loading ? (
          ...
          <Button
            ...
            className="w-full h-12 rounded-xl font-medium text-base border-2 border-border hover:bg-muted/50 hover:border-primary/30 transition-all"
          >
